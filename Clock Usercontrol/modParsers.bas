...
Public Enum enumHVoffsets
    eHorz = 1
    eVert = 2
End Enum

Public Enum enumClockHands
    [eHour] = 1
    [eMinute] = 2
    [eSecond] = 3
End Enum
...
Public Function iparseIsArrayEmpty(lArrayPointer As Long) As Boolean
  ' test to see if an array has been initialized
  Dim safeArrayPointer As Long
  CopyMemory safeArrayPointer, ByVal lArrayPointer, 4&
  iparseIsArrayEmpty = (safeArrayPointer = 0)
End Function
                ...
                Do
                    ...
                    Select Case asmVal
                        Case &HC3               ' exit code, no stack clean up
                            CopyMemory asmVal, ByVal pa - 1&, 1&
